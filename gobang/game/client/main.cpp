...
{
    cout<<"Usage: "<< proc <<"请输入ip和端口号："<<endl;
}
           ...
           case 1:
               {
                  ...
                  if(result >=10000)//此时已经注册了，登录的ID应当是新分配的，而不再是初始的0了
                  {
                      id = result;//将新分配的ID号，赋给ID
